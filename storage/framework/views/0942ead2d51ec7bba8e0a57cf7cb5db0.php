                ...
                <div class="dashboard-controls">
                    <form action="<?php echo e(route('status.update.theme', $status->id)); ?>" method="POST" id="themeForm">
                        ...
                        <select class="theme-select" name="template_theme" onchange="document.getElementById('themeForm').submit()" aria-label="Choose flyer style">
                            <option value="dark_slate" <?php echo e($status->template_theme == 'dark_slate' ? 'selected' : ''); ?>>Style: Midnight</option>
                            <option value="spicy_red" <?php echo e($status->template_theme == 'spicy_red' ? 'selected' : ''); ?>>Style: Red</option>
                            <option value="golden_glow" <?php echo e($status->template_theme == 'golden_glow' ? 'selected' : ''); ?>>Style: Gold</option>
                            <option value="minimal_clean" <?php echo e($status->template_theme == 'minimal_clean' ? 'selected' : ''); ?>>Style: Mint</option>
                            <option value="ocean_blue" <?php echo e($status->template_theme == 'ocean_blue' ? 'selected' : ''); ?>>Style: Blue</option>
                            <option value="royal_plum" <?php echo e($status->template_theme == 'royal_plum' ? 'selected' : ''); ?>>Style: Plum</option>
                        </select>
                    </form>
        ...
        <?php if($status): ?>
            ...
            <form action="<?php echo e(route('status.save.refresh', $status->id)); ?>" method="POST" style="width: 100%; margin-bottom: 12px;">
                ...
                <div class="caption-box">
                    <textarea name="generated_text" id="captionText" required placeholder="Type your offer message here..." style="font-family: <?php echo e($fontFamily); ?>; font-size: <?php echo e(min(24, max(16, $fontSize))); ?>px;"><?php echo e(trim($status->generated_text)); ?></textarea>
                </div>
